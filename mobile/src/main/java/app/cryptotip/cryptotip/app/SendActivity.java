...
public class SendActivity extends GActivity {
    ...
    private CardView ledgerCardView;
    private GTextView ledgerButtonTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ledgerCardView = layout.findViewById(R.id.ledger_card_view);
        ledgerButtonTextView = layout.findViewById(R.id.ledger_send_transaction_button);
        ...
        ledgerButtonTextView.text("Send with Ledger");
        ledgerCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(cryptoAmount != null && cryptoAmount > 0){
                    ...
                    if(selectedCrypto != null && !selectedCrypto.contentEquals("ETH")){
                        ...
                        if(!SendActivity.this.isDestroyed() || !SendActivity.this.isFinishing()) {
                            //initLedger(addressTextView.getText().toString(), cryptoAmount.toString());
                        }
                    }
                }
            }
