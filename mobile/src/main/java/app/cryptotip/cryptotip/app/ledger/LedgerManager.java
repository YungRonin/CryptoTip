...
public class LedgerManager extends AbstractAccountScanManager implements
    ...
    private String LEDGER_DISABLE_TEE_SETTING = "ledger_disable_tee";
    private String LEDGER_UNPLUGGED_AID_SETTING = "ledger_unplugged_aid";
    private String LEDGER_SETTINGS_NAME = "ledger_settings";
    ...
    public LedgerManager(Context context, NetworkParameters network, Bus eventBus) {
        ...
        SharedPreferences preferences = this.context.getSharedPreferences(LEDGER_SETTINGS_NAME,
                Activity.MODE_PRIVATE);
        disableTee = preferences.getBoolean(LEDGER_DISABLE_TEE_SETTING, false);
        aid = Dump.hexToBin(preferences.getString(LEDGER_UNPLUGGED_AID_SETTING, DEFAULT_UNPLUGGED_AID));
    }
